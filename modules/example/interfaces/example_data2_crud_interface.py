...
from modules.example.db.tiny.tiny_db_service import TABLE_EXAMPLE_DATA2_LIST
from modules.example.icons import icons


class ExampleData2Interface(QWidget, MFieldMixin):
    def __init__(self, parent=None):
        super(ExampleData2Interface, self).__init__(parent)
        self.table_example_data2_list = TABLE_EXAMPLE_DATA2_LIST
    ...
    def reload_data(self):
        ...
        :return:
        """
        self.total_count = len(self.table_example_data2_list)  # 数据总数
        ...
        self.data_list = self.table_example_data2_list.all()[start_index:start_index + self.page_size]
    ...
    def data_changed_handle(self, param: QModelIndex):
        ...
        if param.isValid():
            ...
            self.table_example_data2_list.update(copy, doc_ids=[row_data.doc_id])
    ...
    def add(self):
        ...
        :return:
        """
        self.table_example_data2_list.insert({
            "name": "",
            "prompt": "",
            "message_number": 0,
            "status": "启用",
    ...
    def delete(self):
        ...
        self.table_example_data2_list.remove(doc_ids=checked_doc_ids)
        self.reload_data()
...
if __name__ == '__main__':
    ...
    # 创建窗口
    demo_widget = ExampleData2Interface()
